...
export const Bio = {
  ...
  resume:
    "https://docs.google.com/document/d/1SeN0LJ8sqzBzUoUtNEYQkBshfdMGyllD76Pf81BLnLo/edit#heading=h.5rf9wr4r3no2/",
...
export const projects = [
  {
    id: 11,
    title: "Vervoe",
    date: "Feb 2024 - Dec 2023",
    description:
      "A website which helps other companies hire employees based on merit, not background.",
    image:
      `${VervoeImg}`,
    tags: [
      "React", 
  ...
  },
  {
    ...
    description:
      "Nota20 is a website which is implemented using Laravel as a backend and ",
    image:
    `${Nota20Img}`,
    tags: [
      "Docker",
